...
export default function NewsCard() {
	...
	return (
		<>
			<h1
				id="top"
				className="px-10 pt-5 sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900 dark:text-white">
				Top Headlines :
			</h1>
				...
				{page < Math.ceil(totalResults / pageSize) && (
					<button
						onClick={() => {
							...
							console.log(api);
							// window.scrollTo(0, 0);
							// scrollTo TOp of the screen
							// window.scrollTo({
							// 	top: 0,
							// 	behavior: 'smooth',
							// });
							// // document
							document.getElementById('top').scroll();
						}}
						type="button"
						className="flex justify-center items-center
					space-x-2 border border-gray-700 bg-gray-700 text-white
